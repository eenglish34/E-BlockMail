Contributing to Eblockmail Core
============================

The Eblockmail Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Eblockmail Core project, and is not to be
confused with overall Eblockmail Network Protocol consensus changes.

Whether a pull request is merged into Eblockmail Core rests with the project merge
...
Patches that change Eblockmail consensus rules are considerably more involved than
...
Where a patch set proposes to change the Eblockmail consensus, it must have been
...
The project leader is the release manager for each Eblockmail Core release.
