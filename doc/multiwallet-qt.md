...
In order to support loading of multiple wallets in eblockmail-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is eblockmail.cpp.
...
Changes to eblockmail.cpp
----------------------
eblockmail.cpp is the entry point into eblockmail-qt, and as such, will require some minor modifications to provide hooks for
