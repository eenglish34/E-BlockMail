...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/eastcoastcrypto/eblockmail-detached-sigs.git
...
### Build and sign Eblockmail Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit eblockmail=v${VERSION} ../eblockmail/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gsign --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs/ ../eblockmail/contrib/gitian-descriptors/gitian-aarch64.yml
    mv build/out/eblockmail-*.tar.gz build/out/src/eblockmail-*.tar.gz ../
    popd
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import eblockmail/contrib/gitian-keys/*.gpg
    gpg --refresh-keys
...
- Detached signatures will then be committed to the [eblockmail-detached-sigs](https://github.com/eastcoastcrypto/eblockmail-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the eblockmailcoin.com server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/eastcoastcrypto/Eblockmail/releases/new) with a link to the archived release notes.
