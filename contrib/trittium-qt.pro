...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/eblockmail-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/eblockmail-cli.cpp \
           src/eblockmail-tx.cpp \
           src/eblockmail.cpp \
           src/db.cpp \
           ...
           src/qt/eblockmail.cpp \
           src/qt/eblockmailstrings.cpp \
...
RESOURCES += src/qt/eblockmail.qrc src/qt/eblockmail_locale.qrc

TRANSLATIONS += src/qt/locale/eblockmail_bg.ts \
                src/qt/locale/eblockmail_de.ts \
                src/qt/locale/eblockmail_en.ts \
                src/qt/locale/eblockmail_es.ts \
                src/qt/locale/eblockmail_fi.ts \
                src/qt/locale/eblockmail_fr.ts \
                src/qt/locale/eblockmail_it.ts \
                src/qt/locale/eblockmail_ja.ts \
                src/qt/locale/eblockmail_pl.ts \
                src/qt/locale/eblockmail_pt.ts \
                src/qt/locale/eblockmail_ru.ts \
                src/qt/locale/eblockmail_sk.ts \
                src/qt/locale/eblockmail_sv.ts \
                src/qt/locale/eblockmail_vi.ts \
                src/qt/locale/eblockmail_zh_CN.ts \
                src/qt/locale/eblockmail_zh_TW.ts
