...
#define PACKAGE_BUGREPORT "www.eblockmail.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Eblockmail Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Eblockmail Core 2.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "eblockmail"
