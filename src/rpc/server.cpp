...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"eblockmail", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"eblockmail", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"eblockmail", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
