...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 34888;
        //bnProofOfWorkLimit = ~uint256(0) >> 1; // Eblockmail starting difficulty is 1 / 2^12
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Eblockmail coin for life 6/10/2018";
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
  //      vSeeds.push_back(CDNSSeedData("testnet.eblockmail.io", "testnet.eblockmail.io"));         // Single node address
//        vSeeds.push_back(CDNSSeedData("testnet1.eblockmail.io", "testnet1.eblockmail.io"));       // Single node address
    //    vSeeds.push_back(CDNSSeedData("testnet2.eblockmail.io", "testnet2.eblockmail.io"));       // Single node address
