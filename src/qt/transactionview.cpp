                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Bit from zBit"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBit"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBit));
