                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Eblockmail from zEblockmail"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zEblockmail"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zEblockmail));
