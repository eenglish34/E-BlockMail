...
/* EBlockmail GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "EBlockmail"
#define QAPP_ORG_DOMAIN "eblockmail.org"
#define QAPP_APP_NAME_DEFAULT "EBlockmail-Qt"
#define QAPP_APP_NAME_TESTNET "EBlockmail-Qt-testnet"
