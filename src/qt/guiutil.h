...
/** Utility functions used by the Eblockmail Qt UI.
 */
namespace GUIUtil
{
...
// Render Eblockmail addresses in monospace font
...
// Parse "eblockmail:" URI into recipient object, return true on successful parsing
