...
/** Utility functions used by the Bitmoney Qt UI.
 */
namespace GUIUtil
{
...
// Render Bitmoney addresses in monospace font
...
// Parse "bitmoney:" URI into recipient object, return true on successful parsing
