...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bitmoney Core"),
     ...
     * override -datadir in the bitmoney.conf file in the default data directory
     * (to be consistent with bitmoneyd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
