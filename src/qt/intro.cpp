...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Eblockmail Core"),
     ...
     * override -datadir in the eblockmail.conf file in the default data directory
     * (to be consistent with eblockmaild behavior)
     */
    if (dataDir != getDefaultDataDirectory())
