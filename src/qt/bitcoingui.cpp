                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bitmoney Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bitmoney Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bitmoney Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bitmoney"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Bitmoney Core help message to get a list with possible Bitmoney command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bitmoney Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitmoney network", "", count));
}
...
{
    QString strTitle = tr("Bitmoney Core"); // default title
