                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Eblockmail Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Eblockmail address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and eblockmail: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCATO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Eblockmail Core"), this);
    aboutAction->setStatusTip(tr("Show information about Eblockmail Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Eblockmail"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Eblockmail addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Eblockmail addresses"));
    ...
    openAction->setStatusTip(tr("Open a Eblockmail: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Eblockmail Core help message to get a list with possible Eblockmail command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Eblockmail Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Eblockmail network", "", count));
}
