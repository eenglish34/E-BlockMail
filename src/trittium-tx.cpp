...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Eblockmail Core eblockmail-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  eblockmail-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded eblockmail transaction") + "\n" +
                               "  eblockmail-tx [options] -create [commands]   " + _("Create hex-encoded eblockmail transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded eblockmail transaction
